    ...
    <div className="first-div w-[289px] 2xl:w-[23.5%] min-h-[650px]  2xl:pb-[1.2vw] h-auto rounded-[6px]">
      ...
      {data.map((item) => (
        <div className="regionalData w-full flex flex-col items-center gap-2 2xl:gap-[.5vw] mt-[6px] 2xl:mt-[1.2vw]">
          ...
          {/* <div className="first data w-[263px] 2xl:w-[91.5%] 2xl:h-[4vw] h-[62.98px]  rounded-[3px]">
            <p className="text-[12px] text-white font-bold ml-1 2xl:text-[1vw]">
              North Region
            </p>
            <div className="flex justify-around items-center h-auto">
              <div className="holder flex justify-center items-center gap-2">
                <div className=" sm:max-w-[5vw] sm:min-w-[5vw]">
                  <p className="text-white text-[12px] font-bold ml-1 2xl:text-[.8vw]">
                    Inset{" "}
                    <span className="text-[17px] 2xl:text-[1vw] font-bold">
                      {item.IN_NORTH.toLocaleString()}
                    </span>{" "}
                  </p>
                </div>
                ...
                {item.IN_NORTH_PER >= 0 ? (
                  <div className="icons flex flex-col justify-center items-center arrows">
                    <RiTriangleFill className="text-green-400  w-[17px] h-[20.59px] 2xl:w-[1.1vw] 2xl:h-[1.1vw] ml-[-2px]" />
                    <h1 className="text-[12px] font-bold text-green-400  ml-[-2px] 2xl:text-[.8vw]">
                      +
                      {Math.abs(item.IN_NORTH_PER).toString().length === 1
                        ? "0" + Math.abs(item.IN_NORTH_PER)
                        : Math.abs(item.IN_NORTH_PER)}
                  ...
                  <div className="icons flex flex-col justify-center items-center arrows">
                    <h1 className="text-[12px] font-bold text-[#BE1A1A] 2xl:text-[.8vw]">
                      -
                      {Math.abs(item.IN_NORTH_PER).toString().length === 1
                        ? "0" + Math.abs(item.IN_NORTH_PER)
                        : Math.abs(item.IN_NORTH_PER)}
                    ...
                    <RiTriangleFill className="text-[#BE1A1A] w-[17px] h-[20.59px] rotate-180 2xl:w-[1.1vw] 2xl:h-[1.1vw]" />
                  </div>
                )}
              </div>
              <div className="holder flex justify-center items-center gap-2">
                <div className="sm:max-w-[6vw] sm:min-w-[6vw]">
                  <p className="text-white text-[12px] font-bold ml-[6px] 2xl:text-[.8vw]">
                    Outset{" "}
                    <span className="text-[17px] 2xl:text-[1vw] font-bold">
                      {item.OUT_NORTH.toLocaleString()}
                    </span>{" "}
                ...
                {item.OUT_NORTH_PER >= 0 ? (
                  <div className="icons flex flex-col justify-center items-center ml-[-3px] arrows">
                    <RiTriangleFill className="text-green-400  w-[17px] h-[20.59px] 2xl:w-[1.1vw] 2xl:h-[1.1vw]" />
                    <h1 className="text-[12px] font-bold text-green-400 2xl:text-[.8vw]">
                      +
                      {Math.abs(item.OUT_NORTH_PER).toString().length === 1
                        ? "0" + Math.abs(item.OUT_NORTH_PER)
                        : Math.abs(item.OUT_NORTH_PER)}
          ...
          {/* <div className="first data w-[263px] 2xl:w-[91.5%] 2xl:h-[4vw] h-[62.98px] rounded-[3px] ">
            ...
            <div className="flex justify-around items-center h-auto">
              <div className="holder flex justify-center items-center gap-2">
                ...
                {item.IN_SOUTH_PER >= 0 ? (
                  <div className="icons flex flex-col justify-center items-center ml-1 arrows">
                    <RiTriangleFill className="text-green-400  w-[17px] h-[20.59px] ml-[-6px] 2xl:w-[1.1vw] 2xl:h-[1.1vw]" />
                    <h1 className="text-[12px] font-bold text-green-400 ml-[-6px] 2xl:text-[.8vw]">
                      +
                      {Math.abs(item.IN_SOUTH_PER).toString().length === 1
                        ? "0" + Math.abs(item.IN_SOUTH_PER)
                        : Math.abs(item.IN_SOUTH_PER)}
              ...
              <div className="holder flex justify-center items-center gap-2">
                ...
                {item.OUT_SOUTH_PER >= 0 ? (
                  <div className="icons flex flex-col justify-center items-center arrows ml-[-3px]">
                    <RiTriangleFill className="text-green-400  w-[17px] h-[20.59px] 2xl:w-[1.1vw] 2xl:h-[1.1vw] " />
                    <h1 className="text-[12px] font-bold text-green-400 2xl:text-[.8vw]">
                      +
                      {Math.abs(item.OUT_SOUTH_PER).toString().length === 1
