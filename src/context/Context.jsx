...
//  TABLE
const fourthTableCustomFieldNames = ["WEEKS", "PART_WAITING", "UNDER_REPAIR","COMPLETED","OTHER","WT_DAY","DAY_0_PER","DAY2_3","DAY2_3_PER","DAY4_7","DAY4_7_PER","DAY8_ABOVE","DAY8_ABOVE_PER"];

const fieldsToExtractRawalpinditopTableFourth = ["WEEKS","RWP_PART_WAITING","RWP_UNDER_REPAIR","RWP_COMPLETED","RWP_OTHERS","RWP_WT_DAY","RWP_DAY_0_PER","RWP_DAY2_3","RWP_DAY2_3_PER","RWP_DAY4_7","RWP_DAY4_7_PER","RWP_DAY8_ABOVE","RWP_DAY8_ABOVE_PER"];
const fieldsToExtractFaisalabadtopTableFourth = ["WEEKS","FSD_PART_WAITING","FSD_UNDER_REPAIR","FSD_COMPLETED","FSD_OTHERS","FSD_WT_DAY","FSD_DAY_0_PER","FSD_DAY2_3","FSD_DAY2_3_PER","FSD_DAY4_7","FSD_DAY4_7_PER","FSD_DAY8_ABOVE","FSD_DAY8_ABOVE_PER"];
const fieldsToExtractGujranwalatopTableFourth = ["WEEKS","GUJ_PART_WAITING","GUJ_UNDER_REPAIR","GUJ_COMPLETED","GUJ_OTHERS","GUJ_WT_DAY","GUJ_DAY_0_PER","GUJ_DAY2_3","GUJ_DAY2_3_PER","GUJ_DAY4_7","GUJ_DAY4_7_PER","GUJ_DAY8_ABOVE","GUJ_DAY8_ABOVE_PER"];
const fieldsToExtractLahoretopTableFourth =     ["WEEKS","LHE_PART_WAITING","LHE_UNDER_REPAIR","LHE_COMPLETED","LHE_OTHERS","LHE_WT_DAY","LHE_DAY_0_PER","LHE_DAY2_3","LHE_DAY2_3_PER","LHE_DAY4_7","LHE_DAY4_7_PER","LHE_DAY8_ABOVE","LHE_DAY8_ABOVE_PER"];
const fieldsToExtractMultantopTableFourth =     ["WEEKS","MUL_PART_WAITING","MUL_UNDER_REPAIR","MUL_COMPLETED","MUL_OTHERS","MUL_WT_DAY","MUL_DAY_0_PER","MUL_DAY2_3","MUL_DAY2_3_PER","MUL_DAY4_7","MUL_DAY4_7_PER","MUL_DAY8_ABOVE","MUL_DAY8_ABOVE_PER"];
const fieldsToExtractHyderabadtopTableFourth =  ["WEEKS","HYD_PART_WAITING","HYD_UNDER_REPAIR","HYD_COMPLETED","HYD_OTHERS","HYD_WT_DAY","HYD_DAY_0_PER","HYD_DAY2_3","HYD_DAY2_3_PER","HYD_DAY4_7","HYD_DAY4_7_PER","HYD_DAY8_ABOVE","HYD_DAY8_ABOVE_PER"];
const fieldsToExtractKarachitopTableFourth =    ["WEEKS","KHI_PART_WAITING","KHI_UNDER_REPAIR","KHI_COMPLETED","KHI_OTHERS","KHI_WT_DAY","KHI_DAY_0_PER","KHI_DAY2_3","KHI_DAY2_3_PER","KHI_DAY4_7","KHI_DAY4_7_PER","KHI_DAY8_ABOVE","KHI_DAY8_ABOVE_PER"];
